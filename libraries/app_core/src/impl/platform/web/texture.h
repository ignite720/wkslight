...
struct Texture final : public WebObject {
    ...
    void render(const SDL_FRect *dst_rect, const SDL_FRect *src_rect = nullptr, float angle = 0.0f, const SDL_Point *center = nullptr, SDL_RendererFlip flip = SDL_FLIP_NONE) const;
